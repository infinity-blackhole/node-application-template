...
```shell
cd existing_repo
git remote add origin https://github.com/infinity-blackhole/node-root-commit.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/infinity-blackhole/node-root-commit/-/settings/integrations)
